...
function deepEqual( obj1 , obj2){
    ...
    else if(obj1 instanceof Object)
    {
        ...
        return (obj1Keys.every(obj1K => obj2.hasOwnProperty(obj1K)) ) &&  (obj2Keys.every(obj2K => obj1.hasOwnProperty(obj2K))) &&
...
testCases.forEach(({obj1, obj2, expectedResult})=> console.log(deepEqual(obj1, obj2) , {expectedResult}))